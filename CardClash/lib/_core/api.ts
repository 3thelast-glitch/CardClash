...
export async function getMe(): Promise<{
  ...
  try {
    ...
    console.error("[API] getMe failed:", error instanceof Error ? error.message : "Unknown error");
    return null;
  }
}
...
export async function establishSession(token: string): Promise<boolean> {
  try {
    ...
    console.error("[API] establishSession failed:", error instanceof Error ? error.message : "Unknown error");
    return false;
  }
}
